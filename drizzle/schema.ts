...
export const users = mysqlTable("users", {
  ...
  minecraftSkinType: mysqlEnum("minecraftSkinType", ["licensed", "tlauncher"]).default("licensed").notNull(),
...
export const teamMembers = mysqlTable("team_members", {
  ...
  skinSourceType: mysqlEnum("skinSourceType", ["licensed", "tlauncher"]).default("licensed").notNull(),
